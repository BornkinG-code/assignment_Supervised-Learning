...
<div class='container admin-shell'>
  <header class='admin-topbar card'>
    <div><div class='brand'>Menu Management</div><div class='subtle'>Create and update customer menu items</div></div>
  ...
  <section class='card'>
    <div class='card-body'>
      <h3>Add / Edit Item</h3>
      <form id='menuForm' enctype='multipart/form-data' class='form-grid'>
        ...
        <button class='btn btn-add'>Save Item</button>
      </form>
    </div>
  </section>
