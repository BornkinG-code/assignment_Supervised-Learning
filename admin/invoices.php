...
<div class='container admin-shell'>
  <header class='admin-topbar card'>
    <div><div class='brand'>Invoices</div><div class='subtle'>Monthly order bills and exports</div></div>
    <a class='btn btn-ghost' href='index.php'>Back to Dashboard</a>
  </header>

  <section class='card'>
    <div class='card-body'>
      <table class='table'><thead><tr><th>Order</th><th>Customer</th><th>Total</th><th>Month</th><th>File</th><th>Delete</th></tr></thead><tbody id='rows'></tbody></table>
    </div>
  </section>
</div>
<script>
